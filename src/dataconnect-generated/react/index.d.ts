...
export function useDeleteAllAttemptAnswers(options?: useDataConnectMutationOptions<DeleteAllAttemptAnswersData, FirebaseError, void>): UseDataConnectMutationResult<DeleteAllAttemptAnswersData, undefined>;
export function useDeleteAllAttemptAnswers(dc: DataConnect, options?: useDataConnectMutationOptions<DeleteAllAttemptAnswersData, FirebaseError, void>): UseDataConnectMutationResult<DeleteAllAttemptAnswersData, undefined>;

export function useDeleteAllExamAttempts(options?: useDataConnectMutationOptions<DeleteAllExamAttemptsData, FirebaseError, void>): UseDataConnectMutationResult<DeleteAllExamAttemptsData, undefined>;
export function useDeleteAllExamAttempts(dc: DataConnect, options?: useDataConnectMutationOptions<DeleteAllExamAttemptsData, FirebaseError, void>): UseDataConnectMutationResult<DeleteAllExamAttemptsData, undefined>;
